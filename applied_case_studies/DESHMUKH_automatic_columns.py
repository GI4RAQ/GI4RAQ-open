...
###############################################################################
# Deshmukh et al 2019 - full code with multiple wind directions
###############################################################################
...
# read in meteorology from wind rose
csv_path = 'https://raw.githubusercontent.com/GI4RAQ/GI4RAQ-open/master/applied_case_studies/met_deshmukh.csv'
...
ez1_w = ez1_finish - ez1_start
ez2_w = ez2_finish - ez2_start
    ...
    if rec[0] < zone[0]:
        ...
        if check[2] == 1:
            ...
            if check[3] == 1:
                ...
                if rec[0] < zone[2]: 
                    # which will occur if rec[0] was == zone [2] but has since -0.1
                    l[2] = rec[0] - l[1]
                    l[3] = zone[2] - l[1] - l[2]
                    l[4] = zone[3] - l[1] - l[2] - l[3]
                else:
...
#print("PERPENDICULAR WINDS L-->R BEFORE BARRIER")
#print("Horizontal advection velocities")
#print(ua2_orig)
#print("Horizontal exchange velocities")
#print(ue2_orig)
#print("Vertical advection velocities")
#print(wa2_orig)
#print("Vertical exchange velocities")
#print(we2_orig)
#print("")
# print("ue2_orig")
# print(ue2_orig)
...
# print("PERPENDICULAR WINDS R-->L BEFORE BARRIER")
# print("Horizontal advection velocities")
# print(ua2_mir)
# print("Horizontal exchange velocities")
# print(ue2_mir)
...
#print("PERPENDICULAR WINDS L-->R AFTER BARRIER")
#print("Horizontal advection velocities")
#print(ua3_orig)
#print("Horizontal exchange velocities")
#print(ue3_orig)
...
# print("PERPENDICULAR WINDS R-->L AFTER BARRIER")
# print("Horizontal advection velocities")
# print(ua3_mir)
# print("Horizontal exchange velocities")
# print(ue3_mir)
...
if error[0,0] == 1:
    ...
    print("***************************************************")
    print("IMPORTANT NOTE: Concentrations are printed in order of box from bottom left to top right. There are also 5 columns in each of the wind scenarios, but a total of 7 columns in the weighted results; the dimensioning under perpendicular wind conditions don't exactly align. For concentrations under 1 wind direction, the first 5 results refer to R1, next 5 results refer to R2, and final 5 results refer to R3. In contrast, for weighted concentrations: R1 are the first 7 results, R2 are the next 7 results, and R3 are the final 7 results.")
    print("***************************************************")
    print("")
    ...
    print("WIND L-->R (ADVECTION ON)")
    print("Concentrations before barrier:", C1_orig, sep = "\n")
    print("Concentrations after barrier:", C2_orig, sep = "\n")
    print("Percentage changes:", per_change_no2_orig, sep = "\n")
    print("")
    ...
    print("WIND R-->L (ADVECTION ON)")
    print("Concentrations before barrier (not flipped back):", C1_mir, sep = "\n")
    print("Concentrations after barrier (not flipped back):", C2_mir, sep = "\n")
    print("Percentage changes (not flipped back):", per_change_no2_mir, sep = "\n")
    print("Percentage changes (FLIPPED back):", per_change_no2_mir_flipped, sep = "\n")
    print("")
    ...
    print("WIND PARALLEL")
    print("Absolute concentrations, L--R dimensioning, before barrier:", C1_par_1, sep = "\n")
    print("Absolute concentrations, L--R dimensioning, after barrier:", C2_par_1, sep = "\n")
    print("NO2 % Change (Parallel wind, dimensioning: L->R)", per_change_no2_par_1, sep = '\n')
    print("")
    
    print("WIND PARALLEL")
    print("Absolute concentrations, R--L dimensioning, before barrier (not flipped back):", C1_par_2, sep = "\n")
    print("Absolute concentrations, R--L dimensioning, after barrier (not flipped back):", C2_par_2, sep = "\n")
    ...
    # WEIGTHED ABSOLUTE CONCENTRATIONS
    
    # flip back so each box corresponds to the same space in the street
    no2_abs_mir_flipped = flip_conc(C=C1_mir)

    # flip back those calculated with dimensioning from right-to-left
    no2_raw_par_flipped = flip_conc(C=C1_par_2)
    ...
    weighted_row1_no2 = weighting_concs(l_cumu_LR=l_cumu_original, l_cumu_RL=l_cumu_flipped, 
                                ...
                                C_RL=no2_abs_mir_flipped[0:5], C_RL_par=no2_raw_par_flipped[0:5], 
    ...
    #print("Weighted NO2 row1:", weighted_row1_no2, "\n")
    ...
    weighted_row2_no2 = weighting_concs(l_cumu_LR=l_cumu_original, l_cumu_RL=l_cumu_flipped, 
                                ...
                                C_RL=no2_abs_mir_flipped[5:10], C_RL_par=no2_raw_par_flipped[5:10], 
                                LR_freq=LR_freq, LR_par_freq=LR_par_freq, RL_freq=RL_freq, RL_par_freq=RL_par_freq)
    
    weighted_row2_no2 = weighted_row2_no2[0]
    #print("Weighted NO2 row2", weighted_row2_no2)
    ...
    weighted_row3_no2 = weighting_concs(l_cumu_LR=l_cumu_original, l_cumu_RL=l_cumu_flipped, 
                                ...
                                C_RL=no2_abs_mir_flipped[10:15], C_RL_par=no2_raw_par_flipped[10:15], 
                                LR_freq=LR_freq, LR_par_freq=LR_par_freq, RL_freq=RL_freq, RL_par_freq=RL_par_freq)
    
    weighted_row3_no2 = weighted_row3_no2[0]
    #print(weighted_row3_no2)
    
    raw_no2 = np.concatenate((weighted_row1_no2, weighted_row2_no2, weighted_row3_no2))
    print("Weighted NO2 Absolute Concs (before barrier).", raw_no2, sep = '\n')
    print("")
    ...
    print("Percentage NO2 changes:", per_change_no2, sep = "\n")
